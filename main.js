  //https://teachablemachine.withgoogle.com/models/FjpNqamUw/
  function startClassification() {
    navigator.mediaDevices.getUserMedia({
      audio: true
    });
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/8La2gcReA/model.json', modelReady);
